				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">${user.username}<i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>
							<li><a href="${pageContext.request.contextPath}/module/security/logout.html">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<c:forEach var="item" items="${authorisedMenus}" varStatus="index">
			<dl id="menu-system">
				<dt><i class="Hui-iconfont">&#xe62e;</i> ${item.text}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
					<c:forEach items="${item.children}" var="resc">
						<li><a _href="${resc.attributes.url}" data-title="${resc.text}" href="javascript:void(0)">${resc.text}</a></li>
					</c:forEach>
					</ul>
				</dd>
			</dl>
