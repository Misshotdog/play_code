...
<script type="text/javascript" src="/dist/js/base64.js" charset="UTF-8"></script>
<!--[if IE 6]>
    ...
    <form class="form form-horizontal" method="post" id="loginForm">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input name="username" id="username" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
function login(){
	...
	$("#password").val(BASE64.encoder(password));
    $("#loginForm")[0].submit();
}
</script>
</body>
